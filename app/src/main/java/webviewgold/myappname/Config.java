...
public class Config {
    ...
    public static final String PURCHASECODE = "2aad0312-5a85-4546-becb-5486071f687a";
    // 4. Enjoy your app! :)
    ...
    public static final boolean APPEND_LANG_CODE = true;
